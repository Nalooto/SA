 ...
 * 
 */
@WebServiceClient(name = "webServiceService", targetNamespace = "http://Service/", wsdlLocation = "http://127.0.0.1:9090/Service/webService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICESERVICE_QNAME = new QName("http://Service/", "webServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:9090/Service/webService?wsdl");
    ...
    public WebService getWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Service/", "webServicePort"), WebService.class, features);
    }
